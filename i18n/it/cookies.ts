export default {
  'title': 'Cookies Policy',
    'last-update': 'Last updated: September 23, 2017',
    "intro": `
<p>Verifica il Permesso di Soggiorno ("us", "we", or "our") uses cookies on the https://cps.lysz210.name website (the "Service"). By using the Service, you consent to the use of cookies.</p>       
<p>Our Cookies Policy explains what cookies are, how we use cookies, how third-parties we may partner with may use cookies on the Service, your choices regarding cookies and further information about cookies. Cookies Policy created by <a href="https://termsfeed.com" rel="nofollow">TermsFeed</a> for Verifica il Permesso di Soggiorno.</p>`,
    'what-title': 'What are cookies',
    'what-content': `
<p>Cookies are small pieces of text sent by your web browser by a website you visit. A cookie file is stored in your web browser and allows the Service or a third-party to recognize you and make your next visit easier and the Service more useful to you.</p>
<p>Cookies can be "persistent" or "session" cookies. Persistent cookies remain on your personal computer or mobile device when you go offline, while session cookies are deleted as soon as you close your web browser.</p>`,
    'how-title': 'How Verifica il Permesso di Soggiorno uses cookies',
    'how-content': `
...
<li>
    ...
    'choises-title': 'What are your choices regarding cookies',
    'choises-content': `<p>If you\'d like to delete cookies or instruct your web browser to delete or refuse cookies, please visit the help pages of your web browser.</p>
<p>Please note, however, that if you delete cookies or refuse to accept them, you might not be able to use all of the features we offer, you may not be able to store your preferences, and some of our pages might not display properly.</p>`,
    ...
    'more-title': 'Where can you find more information about cookies',
    'more-content': '<p>You can learn more about cookies and the following third-party websites:</p>',
    'more-list': `<ul>
<li>
